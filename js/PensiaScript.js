...
async function maslulimP(t,moz,hev){ 
  ...
  var z = 0;var dataY;let sugmozP;let sugmuzar
    
    if (moz==="קרנות כלליות"){sugmozP='קרנות פנסיה - כללית';sugmuzar=mozkochX[1];
    }else{ sugmozP='קרנות פנסיה - מקיפה';sugmuzar=mozkochX[0];}
